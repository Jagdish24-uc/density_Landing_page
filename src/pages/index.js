    ...
    <div className={styles.landingPage}>
      <header className={styles.topNav}>
        ...
        <div className={styles.frameParent}>
          <nav className={styles.careerParent}>
      ...
      <div className={styles.groupContainer}>
        ...
        <div className={styles.groupDiv}>
          ...
          <img className={styles.groupChild} alt="" src="/vector.svg" />
          <div className={styles.groupItem} />
          <div className={styles.groupInner} />
      ...
      <div className={styles.frameParent4}>
        ...
        <div className={styles.rectangleParent}>
          ...
          <img className={styles.textureIcon1} alt="" src="/texture6@2x.png" />
        </div>
      ...
      <div className={styles.frameParent18}>
        ...
        <div className={styles.frameParent20}>
          ...
          <img className={styles.textureIcon2} alt="" src="/texture5@2x.png" />
        </div>
      </div>
        ...
        <div className={styles.frameParent33}>
          <div className={styles.asSomeoneWhosAlwaysLookinParent}>
            ...
            <img
              ...
              src="/texture2@2x.png"
            />
            <img className={styles.frameIcon7} alt="" src="/frame1.svg" />
            <img
      ...
      <div className={styles.frameParent34}>
        ...
        <div className={styles.frameParent35}>
          <div className={styles.frameParent36}>
            <img className={styles.frameIcon10} alt="" src="/frame.svg" />
